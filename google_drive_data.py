import os.path
import pickle, tqdm, re, requests
...
def download_file_from_google_drive(id, destination):
    ...
    def save_response_content(response, destination):
        ...
        progress = tqdm.tqdm(response.iter_content(CHUNK_SIZE), f"Downloading {filename}", total=file_size, unit="Byte", unit_scale=True, unit_divisor=1024)
